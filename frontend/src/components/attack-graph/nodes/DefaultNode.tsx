...
function DefaultNode({ data, selected }: NodeProps<GraphNode>) {
  ...
  return (
    ...
    >
      {/* Gray gradient header strip */}
      <div className="h-1 rounded-t-lg bg-gradient-to-r from-gray-500 to-gray-400" />
      ...
      <Handle
        ...
        className="!w-2 !h-2 !bg-gray-500 !border-background !border-2"
      />
      <Handle
        type="source"
